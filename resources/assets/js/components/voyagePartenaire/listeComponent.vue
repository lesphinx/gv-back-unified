...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            search_voyage() {
                axios.post('/voyage-partenaire/deeper_search', this.search_form)
                    .then((response) => {
                        this.liste_voyages = [];
            ...
            removeVoyage(voyage, index) {
                swal.fire({
                    ...
                    axios.delete('/voyage-partenaire/'+voyage.slug)
                        .then( (response) => {
                            swal.fire(
                                'Supprimé!',
            ...
            all_voyage(page, par_page){
                axios.get('/voyage-partenaire?page='+page+'&parPage='+par_page)
                    .then( (response) => {
