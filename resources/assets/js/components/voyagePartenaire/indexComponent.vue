<template>
    <div class="card">
        <div class="card-body">
            ...
            <hr>
            <template v-if="list">
                <liste-voyage-partenaire></liste-voyage-partenaire>
            </template>
            <template v-if="update">
                <update-voyage-partenaire :voyage=voyage_update></update-voyage-partenaire>
            </template>
            <template v-if="create">
                <create-voyage-partenaire></create-voyage-partenaire>
            </template>
            <template v-if="detail">
                <detail-voyage-partenaire :voyage="voyage_detail"></detail-voyage-partenaire>
            </template>
        </div>
    </div>
</template>
