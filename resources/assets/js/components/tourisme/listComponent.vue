<template>
    <div class="row">
        ...
        <template v-if="items == null" class="row">
            <b-alert show variant="danger">Pas d'site enregistré pour le moment</b-alert>
        </template>
    </div>
    ...
    export default {
        ...
        methods: {
            ...
            _delete(item) {
                ...
                Swal.fire({
                    title: 'Confirmer la suppression de cet site ',
            ...
            _detail(site) {
                ...
                Swal.fire({
                    title: '<strong>Détail site</strong>',
                    html:
                        '<p><u class="text-success">Titre :</u> ' + site.titre + ' </p>' +
                        '<p><u>Auteur :</u> ' + site.auteur.nom + ' ' + site.auteur.prenom + ' </p>' +

                        '<p><u> Contenu :</u>  </p>' + site.contenu + ' <br>',
