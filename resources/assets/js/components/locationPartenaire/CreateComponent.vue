                ...
                <div class="col-6">
                    <b-row>
                        <!-- <div class="form-group col-6">
                            <label for="partenaireId" class="obligatoire"> Partenaire</label>
                             ...
                             <input type="text" value="Nom du Partenaire"  class="form-control" readonly>
                    ...
                    <b-row>
                        ...
                        <b-form-group class="col-6">
                            ...
                            <b-form-select v-model="form_location.ville_location" :options="villes">
                                <template slot="first">
                    ...
                    <b-row>
                        <div class="form-group col-12">
                            <label for="prix_jour" class="form-control-label obligatoire"> Prix par jour (F CFA)</label>
                            <input type="number"  v-model="form_location.prix_jour" class="form-control" id="prix_jour" required>
                            <p v-if="errors.prix_jour" style="color: red">
                                {{errors.prix_jour[0]}}
                            </p>
                        </div>
                    </b-row>
        ...
        methods: {
            ...
            init_form() {
               if ( this.location == null) {
                   ...
                   this.form_location.prix_jour = this.location.prix_jour;
            ...
            onSubmit() {
                ...
                if(this.update) {
                    ...
                    if (!this.is_updated()) {
                        ...
                        axios.put('location-partenaire/'+this.location.slug, this.form_location)
                            .then((response) => {
                                swal.fire({
                                    title: 'Modification!',
                                    type: 'success',
                    ...
                    axios.post('/location-partenaire', this.form_location)
                        .then((response) => {
            ...
            onRestForm() {
                this.form_location.partenaire = null;
                this.form_location.title = '';
                this.form_location.description = '';
                this.form_location.date_debut = '';
                this.form_location.date_fin = '' ;
                this.form_location.photos = [];
                this.form_location.image_to_remove = null;
                this.form_location.prix_jour = null;
                this.form_location.pays_location = null;
                this.form_location.ville_location = null;
                this.$root.$emit('delete_all_image' , true);
            },
