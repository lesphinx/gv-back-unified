        ...
        <div class="col-12" v-if="liste_locations != null || recherche_approfondi">
            ...
            >
                ...
                <template slot="actions" slot-scope="row">
                    ...
                    <b-button v-if="is_admin ||  is_partenaire" pill variant="danger" size="sm"  v-b-tooltip.hover title="Supprimer"
    ...
    export default {
        data(){
            ...
            return {
              ...
              url_all_location : '/location-partenaire',
        ...
        mounted() {
            ...
            handle_user.get_connected_user_role(
                () => {
                    ...
                    object.is_partenaire = handle_user.is_partenaire();
        ...
        methods: {
            ...
            search_location() {
                axios.post('/location-partenaire/deeper_search', this.search_form)
                    .then((response) => {
            ...
            removeLocation(location, index) {
                swal.fire({
                    ...
                    if (result.value) {
                        axios.delete('/location-partenaire/'+location.slug)
                            .then( (response) => {
                                swal.fire(
                                    'Supprimé!',
