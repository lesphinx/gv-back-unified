<template>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <hr>
            <template v-if="list">
                <liste-location-partenaire></liste-location-partenaire>
            </template>
            <template v-if="create">
                <create-location-partenaire :location=location_update></create-location-partenaire>
            </template>
            <template v-if="detail">
                <detail-location-partenaire :location=location_detail></detail-location-partenaire>
            </template>
        </div>
    </div>
</template>
