            ...
            <form v-on:submit.prevent="store()">
                <div class="row">
                    <div class="form-group col-12">
                        ...
                        <input type="text" id="name" v-model="province.nom"
                               placeholder="Nom de la province" class="form-control">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <select class="form-control" v-model="province.pays" @onchange="get_decoupage_un">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <select class="form-control" v-model="province.decoupage_un">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            store() {
                var _self = this;
                var _province = _self.province;
                console.log(_province)
                axios.post('/province', _province)
