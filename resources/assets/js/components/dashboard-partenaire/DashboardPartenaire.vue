  ...
  export default {
    ...
    methods: {
        ...
        countVoyages()
        {
                ...
                this.axios.get('/nombre-voyages-partenaire')
                    .then((response) => {
        ...
        countReservationsConfirmes()
        {
                ...
                this.axios.get('/nombre-reservations-confirmes-partenaire')
                    .then((response) => {
         ...
         countReservationsAnnules()
        {
                ...
                this.axios.get('/nombre-reservations-annules-partenaire')
                    .then((response) => {
        ...
        countLocations()
        {
                ...
                this.axios.get('/nombre-locations-partenaire')
                    .then((response) => {
         ...
         sommeRecette()
        {
                ...
                this.axios.get('/total-recette-voyage-partenaire')
                    .then((response) => {
