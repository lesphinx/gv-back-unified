					...
					<div class="row">
						...
						<div class="col-6">
							...
							<div class="row form-group">
								...
								<div class="text-center image-div" id="my-strictly-unique-vue-upload-multiple-image" style="display: flex; justify-content: center;">

									

									
										<img id="myImg" :src="image(viewRec.images)"  @click="showPub" alt="image publicitaire" v-b-tooltip.hover title="Cliquer pour zoomer">
