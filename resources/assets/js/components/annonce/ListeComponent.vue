  ...
  <b-card  >
            <b-card-text>
                        ...
                        <div class="tab-content" id="myTabContent">
                            <ul class="nav  nav-tabs" id="myTab" role="tablist">
                                ...
                                <li class="baccouleur nav-item">
                                    <a class="nav-link count  text-dark" v-bind:class="{active : etape===1} " id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true"> Soumis Pour Activation</a>
                                </li>
                                <li class="baccouleur nav-item">
                                    <a class="nav-link count text-dark" v-bind:class="{active : etape===2} " id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Déja active</a>
                                </li>
                                <!--li class="nav-item">
                        ...
                        <thead class="text-uppercase ">
                            ...
                            <tbody>
                            <tr v-for="record in records1" v-if="record.etat!=4" class="text-center">
                                <td >{{record.titre}}</td>
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-outline-danger btn-sm" @click="remove1(record.slug)"><i class="fa fa-trash"></i></button>
                              ...
                              <div class="tab-pane fade"  v-bind:class="{active : etape===2,show : etape===2} " id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                ...
                                <div class="col-12" v-if="records != null">
                                    ...
                                    >
                                        ...
                                        <template slot="etat" slot-scope="row" v-if="row.value == 4 ">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            refreshRecord(record) {
                this.records = record.data.content.data;
            },
 ...
 remove1(slug) {
            ...
            let ar = this;
            axios.get('/annonce')
                .then(function(response) { ar.records = response.data;
                ar.records1 = response.data.content.data;
