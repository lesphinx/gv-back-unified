...
Vue.component('province', require('./components/province/Index.vue'));
Vue.component('list-province', require('./components/province/List'));
Vue.component('create-province', require('./components/province/Create.vue'));
Vue.component('detail-province', require('./components/province/Detail.vue'));
Vue.component('update-province', require('./components/province/Update.vue'));
...
Vue.component('tourisme', require('./components/tourisme/IndexComponent'));
Vue.component('liste-tourisme', require('./components/tourisme/listComponent'));
Vue.component('create-tourisme', require('./components/tourisme/CreateComponent'));
Vue.component('detail-tourisme', require('./components/tourisme/detailComponent'));
Vue.component('multiple-image', require('./components/tourisme/multipleImage'));
