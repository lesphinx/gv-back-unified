...
class VoyageResource extends JsonResource
{
    ...
    public function toArray($request)
    {
      ...
      return [
          ...
          'etat'=>$this->etat,
          'image'=>new Image($this->image_relation_ship),
          'slug'=>$this->slug,
          ...
          'partenaire'=>new Partenaire($this->partenaire_relation_ship),
          'itineraire'=>new Itineraire($this->itineraire_relation_ship),
