...
class ReservationLocationController extends Controller
{
    ...
    {
        $voyages = ReservationLocationResource::collection(ReservationLocation::orderBy('created_at','desc')->where('client', '=' , $id_user)->get());
        return response()->json([
            'content'=> $voyages,
            'message'=>'liste des Reservations locations'],
