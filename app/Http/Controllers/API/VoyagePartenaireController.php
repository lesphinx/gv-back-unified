...
class VoyagePartenaireController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if( $client == 1 ) {
            ...
            $voyages = new VoyageCollection(
                Voyage::where('partenaire', '=' , $partenaire->id)
                ->paginate($perPage = $parPage, $columns = ['*'], $pageName = 'page', $page = $currentPage));
        }
