...
class ClientController extends Controller
{
    ...
    public function show(Request $request,$slug)
    {
        if (Client::where('slug','=',$slug)->first()){
            return response()->json(['content'=>new ClientResource(Client::where('slug','=',$slug)->first()),'message'=>'detail Client'],200,['Content-Type'=>'application/json']);
        }

        return response()->json(['message' => 'echec ,Client does not exist'],404,['Content-Type'=>'application/json']);
    }
