          ...
          if (PositionAnnonce::where('slug','=',$slug)->first()){
           $positionannonce = PositionAnnonce::where('slug','=',$slug)->first();
              if ($request->libelle != null) {
                  $positionannonce->libelle = $request->libelle;
              };

              if ($request->description != null) {
                  $positionannonce->description = $request->description;
              };

              if ($positionannonce->update()){
               $positionannonce =PositionAnnonce::where('slug','=',$slug)->first();
    ...
    public function destroy(Request $request,$slug)
     {
              if (PositionAnnonce::where('slug','=',$slug)->first()){
                    ...
                    deleteLog(PositionAnnonce::class,setZero());
