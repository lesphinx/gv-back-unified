...
class DecoupageUnController extends Controller
{
    ...
    public function index()
    {
                ...
                if(!DecoupageUnResource::collection(DecoupageUn::all())->isEmpty()){
                   fetchLog(DecoupageUn::class);
                    return response()->json(['content'=>DecoupageUnResource::collection(DecoupageUn::all()),'message'=>'liste des DecoupageUns'],200,['Content-Type'=>'application/json']);
