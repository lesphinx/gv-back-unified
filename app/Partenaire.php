...
class Partenaire extends Model
{
    ...
    protected $appends = ['is_actived'];

    function getIsActivedAttribute() {
        $id_user = $this->utilisateur;
        if (Active::where('user_id', '=', $id_user)->first()) {
            return true;
        }
        return false;
    }
    ...
    {
        return $this->hasMany(PiecesJointes::class, 'owner');
    }
